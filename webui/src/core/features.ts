...
const featureDefinitions: FeatureDefinition[] = [
  ...
  { path: '/pools/detail', title: 'Pool Details', routePrefix: '/pools', permission: { resource: 'networks', action: 'list' } },
  ...
  { path: '/scan-profiles', title: 'Scan Profiles', nav: { label: 'Scan Profiles', icon: 'settings', order: 44 }, permission: { resource: 'discovery', action: 'list' } },
  { path: '/scheduled-scans', title: 'Scheduled Scans', nav: { label: 'Scheduled Scans', icon: 'clock', order: 46 }, permission: { resource: 'discovery', action: 'list' } },
  ...
  { path: '/dns/providers', title: 'DNS Providers', routePrefix: '/dns/providers', nav: { label: 'DNS Providers', icon: 'server', order: 57 }, permission: { resource: 'dns', action: 'list' } },
  { path: '/dns/zones', title: 'DNS Zones', routePrefix: '/dns/zones', nav: { label: 'DNS Zones', icon: 'globe', order: 58 }, permission: { resource: 'dns', action: 'list' } },
