...
func (m *Metrics) Export() string {
	...
	out += "# HELP http_request_duration_milliseconds HTTP request duration in milliseconds\n"
	out += "# TYPE http_request_duration_milliseconds summary\n"
	...
	out += "# HELP http_requests_by_code Total HTTP requests by status code\n"
	out += "# TYPE http_requests_by_code counter\n"
	...
	// Application metrics
	out += "# HELP devices_total Total number of devices\n"
	out += "# TYPE devices_total gauge\n"
	out += fmt.Sprintf("devices_total %d\n", m.devicesTotal.Load())

	out += "# HELP networks_total Total number of networks\n"
	out += "# TYPE networks_total gauge\n"
	out += fmt.Sprintf("networks_total %d\n", m.networksTotal.Load())

	out += "# HELP datacenters_total Total number of datacenters\n"
	out += "# TYPE datacenters_total gauge\n"
	out += fmt.Sprintf("datacenters_total %d\n", m.datacentersTotal.Load())

	out += "# HELP discovery_scans_total Total number of discovery scans\n"
	out += "# TYPE discovery_scans_total counter\n"
	out += fmt.Sprintf("discovery_scans_total %d\n", m.discoveryScans.Load())

	out += "# HELP discovery_scan_duration_milliseconds Discovery scan duration in milliseconds\n"
	out += "# TYPE discovery_scan_duration_milliseconds summary\n"
	...
	// Database metrics
	out += "# HELP db_queries_total Total number of database queries\n"
	out += "# TYPE db_queries_total counter\n"
	out += fmt.Sprintf("db_queries_total %d\n", m.dbQueriesTotal.Load())

	out += "# HELP db_query_duration_milliseconds Database query duration in milliseconds\n"
	out += "# TYPE db_query_duration_milliseconds summary\n"
	...
	out += "# HELP db_connections_open Current number of open database connections\n"
	out += "# TYPE db_connections_open gauge\n"
	...
	out += "# HELP go_memory_alloc_bytes Bytes of allocated heap objects\n"
	out += "# TYPE go_memory_alloc_bytes gauge\n"
	out += fmt.Sprintf("go_memory_alloc_bytes %d\n", mem.Alloc)

	out += "# HELP go_memory_sys_bytes Total bytes of memory obtained from the OS\n"
