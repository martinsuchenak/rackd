...
This document defines the storage interfaces and implementation patterns.
...
- SQLite is the default storage backend for the OSS edition
- The Enterprise edition implements the same interfaces with PostgreSQL
- All storage operations should be atomic where possible
- Use transactions for multi-step operations
- IDs are generated using UUIDv7 for time-ordered uniqueness
